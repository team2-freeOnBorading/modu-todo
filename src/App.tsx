...
const App: React.FC = () => {
  const [todos, setTodos] = useState<ITodo[]>([
    { id: 1, task: 'first', priority: Priority.HIGH, status: Status.NOT_STARTED },
    { id: 2, task: 'second', priority: Priority.HIGH, status: Status.IN_PROGRESS },
    { id: 3, task: 'third', priority: Priority.MEDIUM, status: Status.FINISHED },
    { id: 4, task: 'fourth', priority: Priority.MEDIUM, status: Status.NOT_STARTED },
    { id: 5, task: 'fifth', priority: Priority.LOW, status: Status.IN_PROGRESS },
    { id: 6, task: 'sixth', priority: Priority.LOW, status: Status.FINISHED },
  ]);
